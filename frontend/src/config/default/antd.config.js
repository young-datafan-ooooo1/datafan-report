...
const ANTD = {
  ...
  theme: {
    dark: {
      'layout-body-background': '#fff', // 之前是#f0f2f5
      'body-background': '#fff',
      'component-background': '#fff',
      'heading-color': 'rgba(0, 0, 0, 0.85)',
      'text-color': 'rgba(0, 10, 33, 0.85)',
      'text-color-inverse': '#fff',
      'text-color-secondary': 'rgba(0, 10, 33, 0.45)',
      'shadow-color': 'rgba(0, 10, 33, 0.15)',
      ...
      'menu-dark-color': '#8A8F9B', // 之前是rgba(254, 254, 254, 0.65)
